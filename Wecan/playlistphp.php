   ...
   <div class="row">
      ...
      <div class="column">
         ...
         <div class="details">
            ...
            <p>PHP is a server-side scripting language that enables dynamic content generation, database interaction, and server-side processing in web development. It is widely used for creating web applications, websites, and content management systems. PHP is known for its ease of use, compatibility with various web servers, and extensive community support.
            </p>
         </div>
      </div>
   </div>
...
<!-- les video il faut la remplacer-->
      <a class="box" href="video/php-1.mp4"> 
         <i class="fas fa-play"></i>
         <img src="images/post-7-1.png" alt="">
         <h3>Complete PHP  Tutorial (part 01)</h3>
      </a>
      
      <a class="box" href="video/php-2.mp4">
         <i class="fas fa-play"></i>
         <img src="images/post-7-2.png" alt="">
         <h3>Complete PHP  Tutorial (part 02)</h3>
      </a>

      <a class="box" href="video/php-3.mp4">
         <i class="fas fa-play"></i>
         <img src="images/post-7-3.png" alt="">
         <h3>Complete PHP Tutorial (part 03)</h3>
      </a>

      <a class="box" href="video/php-4.mp4">
         <i class="fas fa-play"></i>
         <img src="images/post-7-4.png" alt="">
         <h3>Complete PHP  Tutorial (part 04)</h3>
      </a>

      <a class="box" href="video/php-5.mp4">
         <i class="fas fa-play"></i>
         <img src="images/post-7-5.png" alt="">
         <h3>Complete PHP  Tutorial (part 05)</h3>
      </a>

      <a class="box" href="video/php-6.mp4">
         <i class="fas fa-play"></i>
         <img src="images/post-7-6.png" alt="">
