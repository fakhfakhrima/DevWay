   ...
   <div class="row">
      ...
      <div class="column">
         ...
         <div class="details">
            ...
            <p>
                React is a JavaScript library for building user interfaces, particularly single-page applications and mobile applications. It simplifies the process of building complex user interfaces by enabling developers to create reusable UI components. React uses a virtual DOM to improve rendering performance and allows for server-side rendering.
...
<!-- les video il faut la remplacer-->
      <a class="box" href="video/react-1.mp4"> 
         <i class="fas fa-play"></i>
         <img src="images/post-9-1.png" alt="">
         <h3>Complete React  Tutorial (part 01)</h3>
      </a>
     
      <a class="box" href="video/react-2.mp4">
         <i class="fas fa-play"></i>
         <img src="images/post-9-2.png" alt="">
         <h3>Complete React  Tutorial (part 02)</h3>
      </a>

      <a class="box" href="video/react-3.mp4">
         <i class="fas fa-play"></i>
         <img src="images/post-9-3.png" alt="">
         <h3>Complete React Tutorial (part 03)</h3>
      </a>

      <a class="box" href="video/react-4.mp4">
         <i class="fas fa-play"></i>
         <img src="images/post-9-4.png" alt="">
         <h3>Complete React  Tutorial (part 04)</h3>
      </a>

      <a class="box" href="video/react-5.mp4">
         <i class="fas fa-play"></i>
         <img src="images/post-9-5.png" alt="">
         <h3>Complete React  Tutorial (part 05)</h3>
      </a>

      <a class="box" href="video/react-6.mp4">
         <i class="fas fa-play"></i>
         <img src="images/post-9-6.png" alt="">
         <h3>Complete React Tutorial (part 06)</h3>
      </a>
