   ...
   <div class="row">
      ...
      <div class="column">
         ...
         <div class="details">
            ...
            <p>
                MySQL is a popular open-source relational database management system (RDBMS) used in web development for storing, retrieving, and managing data. It is often used in conjunction with PHP to create dynamic web applications and websites, and is known for its speed, reliability, and ease of use. MySQL supports standard SQL and provides features such as indexing, partitioning, and replication.  
...
<!-- les video il faut la remplacer-->
      <a class="box" href="video/mysql-1.mp4"> 
         <i class="fas fa-play"></i>
         <img src="images/post-8-1.png" alt="">
         <h3>Complete MySQL  Tutorial (part 01)</h3>
      </a>
      
      <a class="box" href="video/mysql-2.mp4">
         <i class="fas fa-play"></i>
         <img src="images/post-8-2.png" alt="">
         <h3>Complete MySQL  Tutorial (part 02)</h3>
      </a>

      <a class="box" href="video/mysql-3.mp4">
         <i class="fas fa-play"></i>
         <img src="images/post-8-3.png" alt="">
         <h3>Complete MySQL Tutorial (part 03)</h3>
      </a>

      <a class="box" href="video/mysql-4.mp4">
         <i class="fas fa-play"></i>
         <img src="images/post-8-4.png" alt="">
         <h3>Complete MySQL  Tutorial (part 04)</h3>
      </a>

      <a class="box" href="video/mysql-5.mp4">
         <i class="fas fa-play"></i>
         <img src="images/post-8-5.png" alt="">
         <h3>Complete MySQL  Tutorial (part 05)</h3>
      </a>

      <a class="box" href="video/mysql-6.mp4">
         <i class="fas fa-play"></i>
         <img src="images/post-8-6.png" alt="">
         <h3>Complete MySQL Tutorial (part 06)</h3>
      </a>
