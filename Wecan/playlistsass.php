   ...
   <div class="row">
      ...
      <div class="column">
         ...
         <div class="details">
            ...
            <p>Sass is a preprocessor that enhances CSS with features like variables, mixins, and nesting, allowing for more efficient and organized stylesheet code.</p>
         </div>
      </div>
   </div>
...
<!-- les video il faut la remplacer-->
      <a class="box" href="video/sass-1.mp4"> 
         <i class="fas fa-play"></i>
         <img src="images/post-6-1.png" alt="">
         <h3>Complete SASS  Tutorial (part 01)</h3>
      </a>
      
      <a class="box" href="video/sass-2.mp4">
         <i class="fas fa-play"></i>
         <img src="images/post-6-2.png" alt="">
         <h3>Complete SASS  Tutorial (part 02)</h3>
      </a>

      <a class="box" href="video/sass-3.mp4">
         <i class="fas fa-play"></i>
         <img src="images/post-6-3.png" alt="">
         <h3>Complete SASS Tutorial (part 03)</h3>
      </a>

      <a class="box" href="video/sass-4.mp4">
         <i class="fas fa-play"></i>
         <img src="images/post-6-4.png" alt="">
         <h3>Complete SASS  Tutorial (part 04)</h3>
      </a>

      <a class="box" href="video/sass-5.mp4">
         <i class="fas fa-play"></i>
         <img src="images/post-6-5.png" alt="">
         <h3>Complete SASS  Tutorial (part 05)</h3>
      </a>

      <a class="box" href="video/sass-6.mp4">
         <i class="fas fa-play"></i>
         <img src="images/post-6-6.png" alt="">
         <h3>Complete SASS Tutorial (part 06)</h3>
      </a>
