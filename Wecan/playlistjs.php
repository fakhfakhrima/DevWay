   ...
   <div class="row">
      ...
      <div class="column">
         ...
         <div class="details">
            ...
            <p> JavaScript is a programming language that enables dynamic behavior and interactivity in web development. It allows you to create:Interactive forms,Content that responds to user actions and Animations and visual effects.
            </p>
